...
async def get_course_by_id(academic_year: int,
    ...
    """
    return await CourseService.get_course_by_id(academic_year, course_id, current_account)
...
async def delete_course(academic_year: int,
    ...
    """
    await CourseService.delete_course(academic_year, course_id, current_account)
