...
async def get_teacher_affectations(profile_id: int, current_account: AuthenticatedAccount) -> list[PydanticAffectation]:
    """
...
async def assign_course_to_profile(affectation: PydanticAffectationInCreate, current_account: AuthenticatedAccount) -> PydanticAffectation:
    """
...
async def unassign_course_from_profile_with_profile_and_course(profile_id: int, course_id: int, current_account: AuthenticatedAccount) -> None:
    """
    This method unassigns a course from a teacher.
    """
