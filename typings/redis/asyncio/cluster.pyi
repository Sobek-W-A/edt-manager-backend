...
class RedisCluster(AbstractRedis, AbstractRedisCluster, AsyncRedisClusterCommands):
    ...
    __slots__ = ...
    def __init__(self, host: Optional[str] = ..., port: Union[str, int] = ..., startup_nodes: Optional[List[ClusterNode]] = ..., require_full_coverage: bool = ..., read_from_replicas: bool = ..., reinitialize_steps: int = ..., cluster_error_retry_attempts: int = ..., connection_error_retry_attempts: int = ..., max_connections: int = ..., db: Union[str, int] = ..., path: Optional[str] = ..., credential_provider: Optional[CredentialProvider] = ..., username: Optional[str] = ..., password: Optional[str] = ..., client_name: Optional[str] = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., health_check_interval: float = ..., socket_connect_timeout: Optional[float] = ..., socket_keepalive: bool = ..., socket_keepalive_options: Optional[Mapping[int, Union[int, bytes]]] = ..., socket_timeout: Optional[float] = ..., retry: Optional[Retry] = ..., retry_on_error: Optional[List[Type[Exception]]] = ..., ssl: bool = ..., ssl_ca_certs: Optional[str] = ..., ssl_ca_data: Optional[str] = ..., ssl_cert_reqs: str = ..., ssl_certfile: Optional[str] = ..., ssl_check_hostname: bool = ..., ssl_keyfile: Optional[str] = ..., address_remap: Optional[Callable[[str, int], Tuple[str, int]]] = ...) -> None:
        ...
