...
from typing import Any, AsyncIterator, Awaitable, Callable, Dict, Iterable, List, Mapping, MutableMapping, NoReturn, Optional, TYPE_CHECKING, Tuple, Type, TypeVar, Union
...
class Redis(AbstractRedis, AsyncRedisModuleCommands, AsyncCoreCommands, AsyncSentinelCommands):
    ...
    async def execute_command(self, *args, **options): # -> EncodableT | bytearray | List[EncodableT] | None:
        """Execute a command and return a parsed response"""
        ...
    
    async def parse_response(self, connection: Connection, command_name: Union[str, bytes], **options): # -> EncodableT | bytearray | memoryview[_I] | List[EncodableT] | None:
...
class PubSub:
    ...
    def __init__(self, connection_pool: ConnectionPool, shard_hint: Optional[str] = ..., ignore_subscribe_messages: bool = ..., encoder=...) -> None:
        ...
...
class Pipeline(Redis):
    ...
    async def immediate_execute_command(self, *args, **options): # -> EncodableT | bytearray | List[EncodableT] | None:
        """
