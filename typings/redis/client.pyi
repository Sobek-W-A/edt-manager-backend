...
def parse_object(response, infotype): # -> int | None:
...
def sort_return_tuples(response, **options): # -> list[Any]:
    """
...
def int_or_none(response): # -> int | None:
    ...
...
def parse_xinfo_stream(response, **options): # -> dict[Any, Any] | dict[str, str]:
    ...
...
def parse_config_get(response, **options): # -> list[str | None] | dict[str | None, str | None] | dict[Any, Any]:
    ...

def parse_scan(response, **options): # -> tuple[int, Any]:
    ...

def parse_hscan(response, **options): # -> tuple[int, Any | dict[str, str] | dict[Any, Any]]:
    ...
...
def parse_cluster_nodes(response, **options): # -> dict[str, dict[str, Any]]:
    """
...
def parse_acl_getuser(response, **options): # -> dict[Any, Any] | dict[str, str] | None:
    ...
...
def parse_module_result(response): # -> Literal[True]:
    ...
...
class Redis(AbstractRedis, RedisModuleCommands, CoreCommands, SentinelCommands):
    ...
    def lock(self, name, timeout=..., sleep=..., blocking=..., blocking_timeout=..., lock_class=..., thread_local=...): # -> Lock:
        """
...
class PubSub:
    ...
    def __init__(self, connection_pool, shard_hint=..., ignore_subscribe_messages=..., encoder=...) -> None:
        ...
    ...
    def get_message(self, ignore_subscribe_messages=..., timeout=...): # -> dict[str, Any] | None:
        """
    ...
    def run_in_thread(self, sleep_time=..., daemon=..., exception_handler=...): # -> PubSubWorkerThread:
        ...
    


class PubSubWorkerThread(threading.Thread):
    def __init__(self, pubsub, sleep_time, daemon=..., exception_handler=...) -> None:
        ...
...
class Pipeline(Redis):
    ...
    def execute_command(self, *args, **kwargs): # -> Self:
        ...
    ...
    def execute(self, raise_on_error=...): # -> list[Any]:
    ...
    def watch(self, *names): # -> Self:
        """Watches the values at keys ``names``"""
        ...
    
    def unwatch(self): # -> Pipeline | Literal[True]:
