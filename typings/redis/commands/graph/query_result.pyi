...
class QueryResult:
    ...
    def parse_records(self, raw_result_set): # -> list[list[Any]]:
        """
    ...
    def parse_array(self, value): # -> list[NoReturn]:
        """
    ...
    @property
    def parse_scalar_types(self): # -> dict[int, Any]:
        ...
    
    @property
    def parse_record_types(self): # -> dict[int, Any]:
        ...
...
class AsyncQueryResult(QueryResult):
    ...
    async def parse_array(self, value): # -> list[Any]:
        """
        Parse array value.
        """
        ...
