...
from typing import Any, AsyncIterator, Awaitable, Callable, Dict, Iterable, Iterator, List, Mapping, Optional, Sequence, Set, TYPE_CHECKING, Tuple, Union
from redis.compat import Literal
from redis.typing import AbsExpiryT, AnyKeyT, BitfieldOffsetT, ChannelT, CommandsProtocol, ConsumerT, EncodableT, ExpiryT, FieldT, GroupT, KeyT, KeysT, PatternT, ScriptTextT, StreamIdT, TimeoutSecT, ZScoreBoundT
...
class ManagementCommands(CommandsProtocol):
    ...
    """
    def auth(self, password, username=..., **kwargs): # -> None:
        """
...
class BitFieldOperation:
    ...
    def incrby(self, fmt: str, offset: BitfieldOffsetT, increment: int, overflow: Union[str, None] = ...): # -> Self:
        """
...
class BasicKeyCommands(CommandsProtocol):
    ...
    def bitfield(self: Union[Redis, AsyncRedis], key: KeyT, default_overflow: Union[str, None] = ...) -> BitFieldOperation:
        """
    ...
    def bitfield_ro(self: Union[Redis, AsyncRedis], key: KeyT, encoding: str, offset: BitfieldOffsetT, items: Optional[list] = ...) -> ResponseT:
        """
...
class SortedSetCommands(CommandsProtocol):
    ...
    def zrevrangebyscore(self, name: KeyT, max: ZScoreBoundT, min: ZScoreBoundT, start: Union[int, None] = ..., num: Union[int, None] = ..., withscores: bool = ..., score_cast_func: Union[type, Callable] = ...): # -> None:
        """
        Return a range of values from the sorted set ``name`` with scores
...
class Script:
    ...
    def __call__(self, keys: Union[Sequence[KeyT], None] = ..., args: Union[Iterable[EncodableT], None] = ..., client: Union[Redis, None] = ...): # -> Awaitable[str] | str:
...
class AsyncScript:
    ...
    async def __call__(self, keys: Union[Sequence[KeyT], None] = ..., args: Union[Iterable[EncodableT], None] = ..., client: Union[AsyncRedis, None] = ...): # -> str:
        """Execute the script, passing any required ``args``"""
        ...
