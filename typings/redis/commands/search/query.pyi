...
class Query:
    ...
    def limit_ids(self, *ids): # -> Self:
        """Limit the results to a specific set of pre-known document
        ids of any length."""
        ...
    
    def return_fields(self, *fields): # -> Self:
        """Add fields to return fields."""
        ...
    
    def return_field(self, field, as_field=...): # -> Self:
        """Add field to return fields (Optional: add 'AS' name
        to the field)."""
        ...
    
    def summarize(self, fields=..., context_len=..., num_frags=..., sep=...): # -> Self:
        """
    ...
    def highlight(self, fields=..., tags=...): # -> Self:
        """
    ...
    def language(self, language): # -> Self:
        """
    ...
    def paging(self, offset, num): # -> Self:
        """
    ...
    def with_payloads(self): # -> Self:
        """Ask the engine to return document payloads."""
        ...
    
    def with_scores(self): # -> Self:
        """Ask the engine to return document search scores."""
        ...
    
    def limit_fields(self, *fields): # -> Self:
        """
    ...
    def sort_by(self, field, asc=...): # -> Self:
        """
    ...
    def expander(self, expander): # -> Self:
        """
...
class NumericFilter(Filter):
    INF = ...
    NEG_INF = ...
    def __init__(self, field, minval, maxval, minExclusive=..., maxExclusive=...) -> None:
        ...
...
class SortbyField:
    def __init__(self, field, asc=...) -> None:
        ...
