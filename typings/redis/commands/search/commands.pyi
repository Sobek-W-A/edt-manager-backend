...
class SearchCommands:
    ...
    def create_index(self, fields, no_term_offsets=..., no_field_flags=..., stopwords=..., definition=..., max_text_fields=..., temporary=..., no_highlight=..., no_term_frequencies=..., skip_initial_scan=...):
        """
    ...
    def add_document(self, doc_id, nosave=..., score=..., payload=..., replace=..., partial=..., language=..., no_create=..., **fields):
        """
    ...
    def info(self): # -> dict[str | Any, str | Any]:
        """
    ...
    def get_params_args(self, query_params: Union[Dict[str, Union[str, int, float]], None]): # -> list[Any]:
        ...
    
    def search(self, query: Union[str, Query], query_params: Dict[str, Union[str, int, float]] = ...): # -> Pipeline | Result:
        """
    ...
    def aggregate(self, query: Union[str, Query], query_params: Dict[str, Union[str, int, float]] = ...): # -> AggregateResult:
        """
    ...
    def profile(self, query: Union[str, Query, AggregateRequest], limited: bool = ..., query_params: Optional[Dict[str, Union[str, int, float]]] = ...): # -> tuple[AggregateResult | Result, dict[Any, Any]]:
        """
    ...
    def spellcheck(self, query, distance=..., include=..., exclude=...): # -> dict[Any, Any]:
        """
    ...
    def config_get(self, option): # -> dict[Any, Any]:
    ...
    def sugget(self, key, prefix, fuzzy=..., num=..., with_scores=..., with_payloads=...): # -> list[Any] | list[Suggestion]:
        """
    ...
    def synupdate(self, groupid, skipinitial=..., *terms):
        """
...
class AsyncSearchCommands(SearchCommands):
    async def info(self): # -> dict[str | Any, str | Any]:
        """
        Get info an stats about the the current index, including the number of
        documents, memory consumption, etc
    ...
    async def search(self, query: Union[str, Query], query_params: Dict[str, Union[str, int, float]] = ...): # -> Pipeline | Result:
        """
        Search the index for a given query, and return a result of documents
    ...
    async def aggregate(self, query: Union[str, Query], query_params: Dict[str, Union[str, int, float]] = ...): # -> AggregateResult:
        """
        Issue an aggregation query.
    ...
    async def spellcheck(self, query, distance=..., include=..., exclude=...): # -> dict[Any, Any]:
        """
        Issue a spellcheck query
    ...
    async def config_get(self, option): # -> dict[Any, Any]:
        """Get runtime configuration option value.
    ...
    async def sugget(self, key, prefix, fuzzy=..., num=..., with_scores=..., with_payloads=...): # -> list[Any] | list[Suggestion]:
        """
        Get a list of suggestions from the AutoCompleter, for a given prefix.
