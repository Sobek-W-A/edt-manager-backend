...
class RedisCluster(AbstractRedisCluster, RedisClusterCommands):
    ...
    def get_node(self, host=..., port=..., node_name=...): # -> None:
        ...
    
    def get_primaries(self): # -> list[Any]:
        ...
    
    def get_replicas(self): # -> list[Any]:
        ...
    ...
    def get_encoder(self): # -> redis.asyncio.connection.Encoder | redis.connection.Encoder:
        """
    ...
    def execute_command(self, *args, **kwargs): # -> dict[Any, Any] | None:
        """
...
class NodesManager:
    def __init__(self, startup_nodes, from_url=..., require_full_coverage=..., lock=..., dynamic_startup_nodes=..., connection_pool_class=..., address_remap: Optional[Callable[[str, int], Tuple[str, int]]] = ..., **kwargs) -> None:
        ...
    ...
    def get_node_from_slot(self, slot, read_from_replicas=..., server_type=...):
        """
        Gets a node that servers this hash slot
        """
        ...
    
    def get_nodes_by_server_type(self, server_type): # -> list[Any]:
        """
...
class ClusterPubSub(PubSub):
    ...
    """
    def __init__(self, redis_cluster, node=..., host=..., port=..., **kwargs) -> None:
        """
...
class ClusterPipeline(RedisCluster):
    ...
    def delete(self, *names): # -> Self:
        """
        "Delete a key specified by ``names``"
        """
        ...
    
    def unlink(self, *names): # -> Self:
        """
